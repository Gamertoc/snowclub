...
import eu.snoware.SnowClub.Queries.SpendenbescheinigungBuchungQuery;
import eu.snoware.SnowClub.Variable.AllgemeineMap;
...
import eu.snoware.SnowClub.gui.input.FormularInput;
import eu.snoware.SnowClub.gui.menu.SpendenbescheinigungMenu;
import eu.snoware.SnowClub.gui.parts.BuchungListTablePart;
import eu.snoware.SnowClub.io.FileViewer;
import eu.snoware.SnowClub.io.FormularAufbereitung;
import eu.snoware.SnowClub.keys.FormularArt;
import eu.snoware.SnowClub.keys.HerkunftSpende;
import eu.snoware.SnowClub.keys.Spendenart;
